...
Public Class frmSpeed
    ...
    Private Sub Timer2_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer2.Tick
        ...
        If tbSetSpeed.Text = String.Empty Or tbKp.Text = String.Empty Or
           tbKi.Text = String.Empty Or tbKd.Text = String.Empty Or lbStatus.Text = "Disconnected" Then
    ...
    Private Sub btSend_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSend.Click
        ...
        send_data(data_set_speed, 10)
        send_data(data_Kp, 11)
        send_data(data_Ki, 12)
        send_data(data_Kd, 13)
    End Sub
    ...
    Private Sub btPosition_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btPosition.Click
        frmPosition.Show()

        If lbStatus.Text = "Connected" Then
            SerialPort1.Close()
            frmPosition.CbCOM.Text = CbCOM.Text
            frmPosition.btConnect.PerformClick()
        End If
